...
const Header = () => {
    return (
        <div className={s.headerContainer}>
            <NavLink to={routes.main} className={s.navLink}>Main </NavLink>
            ...
            <NavLink to={routes.foggotPassword} className={s.navLink}>Foggot password </NavLink>
            ...
            <NavLink to={routes.error404} className={s.navLink}>404 </NavLink>
        </div>
    );
};
